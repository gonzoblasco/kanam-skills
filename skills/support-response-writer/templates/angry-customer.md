...
## Ticket: {{#id}}
## Customer: {{name}}
## Intensity: {{angry / furious / threatening}}
...
I hear you, and I'm sorry. {{specific thing they're upset about}} should not have happened, and I understand why you're frustrated.

**Here's what I'm doing right now:**
1. {{immediate action you're taking}}
2. {{who you're escalating to, if applicable}}
