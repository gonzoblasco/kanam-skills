...
Revenue = Price × Volume
  ├── Price: pricing strategy, discounts, competition
  └── Volume: market size, market share, growth rate
...
2. Company Capability
   ├── Core competencies
   ├── Resources (capital, talent)
   ├── Brand recognition
   └── Distribution channels

3. Go-to-Market Strategy
   ├── Entry mode (build, buy, partner)
   ├── Pricing strategy
   ├── Marketing & sales
   └── Timeline & milestones
```
...
1. Process Mapping
   ...
   ├── Bottlenecks
   ├── Waste (overproduction, waiting, defects)
   └── Cycle time
...
2. Revenue Levers
   ├── Price increase
   ├── Volume increase (new customers, existing customers)
